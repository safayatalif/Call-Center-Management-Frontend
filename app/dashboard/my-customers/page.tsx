...
export default function MyCustomersPage() {
  ...
  const [commMenuPos, setCommMenuPos] = useState<{
    top?: number;
    bottom?: number;
    right: number;
  }>({ right: 0 });
  ...
  const handleSubmitInteraction = async () => {
    ...
    try {
      const followupdatetime =
        interactionData.followupdate && interactionData.followuptime
      ...
      await assignmentAPI.updateInteraction(
        selectedCustomer.assignno_pk,
        updateData
      );

      alert(
        `${interactionType.toUpperCase()} interaction recorded successfully!`
      );
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Manage your assigned customers and interactions
        </p>
      </div>
                            ...
                            <div
                              ...
                              style={{
                                top: commMenuPos.top
                                  ? `${commMenuPos.top}px`
                                  : "auto",
                                bottom: commMenuPos.bottom
                                  ? `${commMenuPos.bottom}px`
                                  : "auto",
                              ...
                              <div className="p-2">
                                ...
                                <div className="border-b border-gray-100 pb-2 mb-2">
                                  ...
                                  >
                                    ...
                                    <span>
                                      Call {customer.custmobilenumber}
                                    </span>
                                  </button>
                                  <button
                                    onClick={() =>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {selectedCustomer.custmobilenumber}
                </p>
              </div>
              <button
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700 mt-1">
                        This customer's target date (
                        {formatDate(selectedCustomer.calltargetdate)}) is in the
                        past. You cannot update or modify data for previous
                        dates.
                      </p>
                    </div>
                  </div>
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-medium">
                      {selectedCustomer.custarea || "-"}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">Previous Calls:</span>
                    <span className="ml-2 font-medium">
                      {selectedCustomer.count_call || 0}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">Last Called:</span>
                    <span className="ml-2 font-medium">
                      {formatDateTime(selectedCustomer.calleddatetime)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setInteractionData({
                      ...interactionData,
                      callstatus_text: e.target.value,
                    })
                  }
                  rows={3}
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#468847] disabled:bg-gray-100 disabled:cursor-not-allowed"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#468847] disabled:bg-gray-100 disabled:cursor-not-allowed"
                      disabled={isTargetDateInPast(
                        selectedCustomer.calltargetdate
                      )}
                    />
                  </div>
                  <div>
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
              ...
              <button
                ...
                title={
                  isTargetDateInPast(selectedCustomer.calltargetdate)
                    ? "Cannot update data for past target dates"
                    : ""
                }
              >
                Save Interaction
