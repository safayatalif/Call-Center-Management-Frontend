                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    {employees.map((employee) => (
                                        <tr key={employee.empno_pk} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                            <td className="py-4 px-4 text-gray-600">{employee.empcode || '-'}</td>
                                            <td className="py-4 px-4">
                                                <div className="font-medium text-gray-900">{employee.name}</div>
                                                <div className="text-xs text-gray-500">{employee.username}</div>
                                            </td>
                                            <td className="py-4 px-4 text-gray-600">{employee.emailidoffical}</td>
                                            <td className="py-4 px-4">
                                            ...
                                            <td className="py-4 px-4">
                                                <span className={`px-2 py-1 rounded-full text-xs font-semibold ${getStatusBadgeColor(employee.empstatus)}`}>
                                                    {employee.empstatus}
                                                </span>
                                            </td>
                                            <td className="py-4 px-4 text-sm text-gray-600">
                                                {employee.officialmobilenum || employee.personalmobilenum || '-'}
                                            </td>
                        ...
                        {pagination.totalPages > 1 && (
                            <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200">
                                <div className="text-sm text-gray-700">
                                    ...
                                    <span className="font-medium">{Math.min(currentPage * itemsPerPage, pagination.totalEmployees)}</span> of{' '}
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setFormData({ ...formData, emailidoffical: e.target.value })}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#468847]"
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setFormData({ ...formData, officialmobilenum: e.target.value })}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#468847]"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setFormData({ ...formData, personalmobilenum: e.target.value })}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#468847]"
                                        />
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Social Media IDs (Official)</label>
                                        <textarea
                                            value={formData.socialmediaidofficial}
                                            onChange={(e) => setFormData({ ...formData, socialmediaidofficial: e.target.value })}
                                            rows={2}
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => setFormData({ ...formData, empremarks: e.target.value })}
                                            rows={3}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-[#468847]"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            onChange={(e) => setFormData({ ...formData, restricteddataprivilege: e.target.checked ? 'Y' : 'N' })}
